...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  ...
  },
  {
    ...
    edges: [
      { id: 'e1-2', source: '1', target: '2', animated: true, type: 'smoothstep' },
      { id: 'e2-3', source: '2', target: '3', animated: true, type: 'smoothstep' },
      { id: 'e3-4', source: '3', target: '4', animated: true, type: 'smoothstep', label: 'Technical' },
      { id: 'e3-5', source: '3', target: '5', animated: true, type: 'smoothstep', label: 'Billing' },
      { id: 'e3-6', source: '3', target: '6', animated: true, type: 'smoothstep', label: 'General' }
    ]
  }
];
